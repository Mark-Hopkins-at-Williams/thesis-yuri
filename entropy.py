...
if __name__ == "__main__":
    ...
    for lang in tqdm(lang_codes):
        src_path = f"/mnt/storage/hopkins/data/flores/dev.{lang}"
        tgt_path = "/mnt/storage/hopkins/data/flores/dev.eng_Latn"

        ce = compute_conditional_entropy(
            lang, src_path, "eng_Latn", tgt_path, base_model, batch_size=1
        )
        print(f"{lang},{ce}")
